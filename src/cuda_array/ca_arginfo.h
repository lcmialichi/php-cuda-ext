...
static zend_function_entry cuda_array_methods[] = {
    ...
    ZEND_ME(CudaArray, greater, arginfo_cuda_array_binary, ZEND_ACC_PUBLIC)
    ZEND_ME(CudaArray, less, arginfo_cuda_array_binary, ZEND_ACC_PUBLIC)
    ZEND_ME(CudaArray, equal, arginfo_cuda_array_binary, ZEND_ACC_PUBLIC)
    ZEND_ME(CudaArray, notEqual, arginfo_cuda_array_binary, ZEND_ACC_PUBLIC)
    ZEND_ME(CudaArray, greaterEqual, arginfo_cuda_array_binary, ZEND_ACC_PUBLIC)
    ZEND_ME(CudaArray, lessEqual, arginfo_cuda_array_binary, ZEND_ACC_PUBLIC)
